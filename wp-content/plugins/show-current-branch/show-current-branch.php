<?php
/*
  Plugin Name: Show Current Branch
  Plugin URI: http://wp.tekapo.com/
  Description: Show the current git branch name in the tool bar.
  Author: JOTAKI Taisuke
  Version: 0.1.0
  Author URI: http://tekapo.com/
  Text Domain: show-current-branch
...
class Show_Branch_Name {

	const TEXT_DOMAIN = 'show-currnet-branch';
	...
	public function get_git_head_file( $param ) {
